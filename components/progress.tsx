    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div ref={headerRef} className="mb-12 md:mb-16 lg:mb-20 text-center">
          ...
          >
            ...
            >
              <span className="relative inline-block">
                <span className="gradient-animated-text">Best results.</span>
                <span
                  ref={glowRef}
          ...
          >
            Quality built into every line of code A workflow that prioritizes
            stability and performance, with multiple layers of testing before
            each release.
          </p>
        </div>
