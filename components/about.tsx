        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          <div className="relative">
            ...
            >
              ...
              >
                <p>
                  Fifteen years ago, I began my odyssey as a freelance
                  developer, a rollercoaster ride where I've been:
                </p>
                <p>• The virtuoso of remote work for elite agencies. </p>
                <p>• The strategic consultant for ambitious startups</p>
                <p> • The master of distributed collaboration</p>

                <p>
                  I'm like a stealthy architect, weaving code spells and
                  conjuring solutions while perfecting my craft to the
                  relentless rhythm of time.
                </p>
                <p>
                  And yes, I may just be the humble architect of your next
                  digital masterpiece!
                </p>
                <p>
                  And yes, I can be the humble creator of your next digital
                  masterpiece.
                </p>
              </div>
            </div>

            <div ref={statsRef} className="mt-8 flex gap-8"></div>
          </div>
