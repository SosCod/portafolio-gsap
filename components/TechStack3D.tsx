  ...
  return (
    ...
    >
      ...
      >
          ...
          <div className="p-6 font-mono text-sm leading-relaxed text-slate-300">
            <div className="flex gap-4">
              ...
              <p>
                ...
                <span className="text-primary-light">SosCode</span> ={' '}
        ...
        <div
          className="floating-card absolute  top-[20%] right-2 md:right-[1%] w-[240px] h-[260px] 
                          bg-[#020D26] rounded-xl border-2 border-secondary/20 shadow-2xl z-30
                       flex flex-col overflow-hidden"
        ...
        <div
          className="floating-card absolute bottom-0 left-[1%] w-[320px] h-[200px]
